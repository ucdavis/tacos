...
/****** Object:  UserDefinedFunction [dbo].[udf_ParseOutCrossListedCourses]    Script Date: 10/19/2018 3:35:49 PM ******/
SET ANSI_NULLS ON
GO
...
-- DECLARE @Course varchar(8) = 'AAS 153' --'CMN 012Y'
-- DECLARE @CrossListing varchar(100) = 'SOC 012Y, POL 012Y, and PSC 012Y' --'MSA 131B and CTS 146B'--'SOC 012Y, POL 012Y, and PSC 012Y'
