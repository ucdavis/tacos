...
namespace tacos.core.Migrations
{
    ...
    [Migration("20260526120500_MaterializeCourseRebuildSpanOptions")]
    public partial class MaterializeCourseRebuildSpanOptions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                ...
                BEGIN
                    ...
                    BEGIN
                        THROW 50000, 'CoursesRaw source table is required before course rebuild options can be listed.', 1;
                    END;

                    CREATE TABLE #AvailableTermCodes
                    (
                        [AcademicTermCode] nvarchar(6) NOT NULL,
                        [AcademicYear] nvarchar(20) NULL
                    );

                    INSERT INTO #AvailableTermCodes
                    (
                        [AcademicTermCode],
                        [AcademicYear]
                    )
                    ...
                    CREATE CLUSTERED INDEX [IX_AvailableTermCodes_AcademicTermCode_AcademicYear]
                    ON #AvailableTermCodes ([AcademicTermCode], [AcademicYear]);

                    ;WITH AvailableAcademicYears AS
                    (
                        SELECT DISTINCT
                            CASE
                    ...
                    (
                        ...
                        (
                            ...
                            FROM #AvailableTermCodes AvailableTermCodes
